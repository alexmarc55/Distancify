...
public class EmulatorNetworking {
    ...
    public List<Map<String, Object>> getRescue() throws IOException, InterruptedException {
        ...
        System.out.println("All Rescue: " + filteredLocations);
        return filteredLocations;
    }

    public List<Map<String, Object>> getUtility() throws IOException, InterruptedException {
        ...
        System.out.println("All Utility: " + filteredLocations);
        return filteredLocations;
    }
}
